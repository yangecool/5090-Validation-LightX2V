#!/bin/bash
# MiniMax-H3 RTX 5090 inference: tp8_int8_ref2av.
# 20 steps, 362 frames, 768 x 1344, 24 FPS, seed 42.
# Optional comparison configuration; not yet validated.
set -u
...
torchrun --standalone --nproc_per_node=8 -m lightx2v.infer \\
  ...
  --config_json /data/h3_cfg/5090_tp8_int8_20step_768p_362f_ref2av.json \\
